<%@ Page Title="" Language="C#" MasterPageFile="~/secure/CherryPantry.Master" AutoEventWireup="true" CodeBehind="Checkout.aspx.cs" Inherits="FoodPantry.Checkout" %>
        ...
        <div class="pos">
            <div class="box box-primary" style="height: 100%">
                ...
                <div class="box-body pt-4" id="pos-box">
                    <input type="text" id="txtSearchUPC" title="Click in the Textbox to Use Scanner." class="scan-box form-control form-control-danger tooltipper" placeholder="Search Product by Code or Category" />
