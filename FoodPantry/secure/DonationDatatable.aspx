<%@ Page Title="" Language="C#" MasterPageFile="~/secure/CherryPantry.Master" AutoEventWireup="true" CodeBehind="DonationDatatable.aspx.cs" Inherits="FoodPantry.DonationDatatable" %>
...
<%--    <link rel="stylesheet" href="css/inventory.css" type="text/css" />--%>
    <link rel="stylesheet" href="css/donationDatatable.css" type="text/css" />
                          ...
                          <span class='input-group-text w-100'>Email</span>
                            ...
                            <div class='input-group w-100 p-3'>
                                <div class='input-group-prepend' style='width: 30%;' >
                                    ...
                                    <input id='txtDonationDate' type='text' class='form-control'/>
                             </div>
