<%@ Page Title="" Language="C#" MasterPageFile="~/secure/CherryPantry.Master" AutoEventWireup="true" CodeBehind="Sales.aspx.cs" Inherits="FoodPantry.Sales" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="js/SalesDT.js"></script>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><input name="max" id="max" type="text"></td>
                    ...
                    <table id="receiptDatatable" class="table table-striped table-hover table-bordered style="width: 100%">
                        <thead>
                            <tr>
                                <th>Order Number</th>
                                <th>Last Name</th>
